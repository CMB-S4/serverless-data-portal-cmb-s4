...
def write_dataset(dset, n_files, data_size, file_table_rows):
    ...
    dset_text = f"""---
title: "Dataset: PanEx V1 Skies BK18 {dsettext}"
author: "Simons Observatory Collaboration"
description: "PanEx V1 Skies BK18 {dset}"
